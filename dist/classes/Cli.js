...
class Cli {
    ...
    async createCar() {
        ...
        while (!validInput) {
            ...
            const car = new Car(Cli.generateVin(), // Generate VIN
            answers.color, answers.make, answers.model, year, weight, topSpeed, [] // Assuming an empty array for optional properties, adjust as necessary
            );
    ...
    async createTruck() {
        ...
        while (!validInput) {
            ...
            const truck = new Truck(Cli.generateVin(), answers.color, answers.make, answers.model, year, weight, topSpeed, wheels, // Pass the array of Wheel objects
    ...
    async createMotorbike() {
        ...
        while (!validInput) {
            ...
            const motorbike = new Motorbike(Cli.generateVin(), answers.color, answers.make, answers.model, year, weight, topSpeed, [frontWheel, rearWheel] // Passes front and rear wheels in an array
            );
